						...
						<div class="col-sm-4 text-center">
							...
							<c:forEach items="${employees}" var="employee">
								<div class="radio yellow-note" style="padding: 2%;">
									<label> <input type="radio" name="nick"
										value="${employee.getNick()}" required>
						...
						<div class="col-sm-4 text-center">
							<div class="form-group">
								<label for="content">Content:</label> <input
									...
									name="content" minlength="8" maxlength="64"
					...
					<div class="row" style="margin-bottom: 1%;">
						...
						<div class="col-xs-3 col-md-2 text-right">
							<a class="btn btn-default"
								href="project?idProject=${project.getId()}"> « Back to the
								projeto </a>
						</div>
						<div class="col-xs-4 col-md-2"></div>
						<div class="col-xs-3 col-md-6 text-right">
							<button class="btn btn-primary">Add uma tarefa »</button>
						</div>
						<div class="col-xs-1"></div>
					</div>
				</form>
